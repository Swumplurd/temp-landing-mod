function buildPackageCardInLivePackage({
    ...
    /* if (idproducto == 81140) {
      cardContainer.style = "min-height: 0"
    } */
    cardContainer.id = idproducto + "-in-live-package";

    if (idproducto === 81120) {
      cardContainer.style = "border-radius: 15px"
    }
    if (idproducto === 81140) {
      cardContainer.style += "height: fit-content; min-height: 0;"
    }
    ...
    if (idproducto === 81130) {
      ...
      divContainer.classList.add("text-center", "mx-3")
      const channelOffer = document.createElement("h4")
      const viewAllChannelsButton = document.createElement("div")
      
      channelOffer.innerHTML = "172 canales de TV"
      viewAllChannelsButton.innerHTML = `
      ...
      const replayTvContainer = document.createElement("div")
      replayTvContainer.classList.add("d-flex","justify-content-center")
      const textReplay = document.createElement("p")
      textReplay.innerHTML = "Pausa y repite tus <br> programas de TV"

      replayTvContainer.innerHTML = `
        <img style="width: 42px; height: 42px" src="assets/grabacion/replaytv.webp" alt="Replay TV" class="features-replay-icon">
      `
      replayTvContainer.appendChild(textReplay)

      divContainer.appendChild(channelOffer)
      divContainer.appendChild(viewAllChannelsButton)
      divContainer.appendChild(replayTvContainer)
    ...
    /* if (idproducto === 81140) {
      ...
      viewAllChannelsButton.innerHTML = `
       <a type="button" class="btn-channelsModal my-3 justify-content-center" id="modal-btn-22" style="text-decoration: none; font-size: 18px;">
          <span class="material-symbols-outlined">visibility</span>
          <span style="text-decoration:underline;">VER TODOS LOS CANALES</span>
        </a>
      `
